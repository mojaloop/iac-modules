...
inputs = {
  ...
  mojaloop_stateful_mangd_override_file    = find_in_parent_folders("${get_env("CONFIG_PATH")}/finance-portal-values-override.yaml", "finance-portal-values-override.yaml")
  finance_portal_values_override_file      = find_in_parent_folders("${get_env("CONFIG_PATH")}/mojaloop-stateful-resources-managed-override.yaml", "mojaloop-stateful-resources-managed-override.yaml")
