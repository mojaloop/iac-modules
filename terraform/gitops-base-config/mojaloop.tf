module "generate_mojaloop_files" {
  ...
  var_map = {
    ...
    nginx_jwt_namespace                         = var.keycloak_namespace
    ...
    account_lookup_db_host                      = "${local.stateful_resources[local.ml_als_resource_index].logical_service_name}.${var.stateful_resources_namespace}.svc.cluster.local"
    ...
    central_ledger_db_host                      = "${local.stateful_resources[local.ml_cl_resource_index].logical_service_name}.${var.stateful_resources_namespace}.svc.cluster.local"
    ...
    central_settlement_db_host                  = "${local.stateful_resources[local.ml_cl_resource_index].logical_service_name}.${var.stateful_resources_namespace}.svc.cluster.local"
    ...
    quoting_db_host                             = "${local.stateful_resources[local.ml_cl_resource_index].logical_service_name}.${var.stateful_resources_namespace}.svc.cluster.local"
    ...
    cep_mongodb_host                            = "${local.stateful_resources[local.cep_mongodb_resource_index].logical_service_name}.${var.stateful_resources_namespace}.svc.cluster.local"
    ...
    cl_mongodb_host                             = "${local.stateful_resources[local.bulk_mongodb_resource_index].logical_service_name}.${var.stateful_resources_namespace}.svc.cluster.local"
    ...
    ttk_mongodb_host                            = "${local.stateful_resources[local.ttk_mongodb_resource_index].logical_service_name}.${var.stateful_resources_namespace}.svc.cluster.local"
    ...
    third_party_consent_db_host                 = "${local.stateful_resources[local.third_party_consent_oracle_db_resource_index].logical_service_name}.${var.stateful_resources_namespace}.svc.cluster.local"
    ...
    third_party_auth_db_host                    = "${local.stateful_resources[local.third_party_auth_db_resource_index].logical_service_name}.${var.stateful_resources_namespace}.svc.cluster.local"
    ...
    third_party_auth_redis_host                 = "${local.stateful_resources[local.third_party_redis_resource_index].logical_service_name}.${var.stateful_resources_namespace}.svc.cluster.local"
