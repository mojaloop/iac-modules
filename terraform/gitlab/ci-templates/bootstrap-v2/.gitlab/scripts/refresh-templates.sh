...
cp -r $CC_TMP_TEMPLATE_DIR/k8s-deploy/ $CC_TMP_TEMPLATE_DIR/ansible-k8s-deploy/  $CC_TMP_TEMPLATE_DIR/.gitlab  $CC_TMP_TEMPLATE_DIR/.gitlab-ci.yml $CC_TMP_TEMPLATE_DIR/setcivars.sh  .
