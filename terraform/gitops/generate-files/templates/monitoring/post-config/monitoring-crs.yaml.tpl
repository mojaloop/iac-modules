...
spec:
  ...
  instanceSelector:
    matchLabels:
      dashboards: "grafana"
  url: "https://raw.githubusercontent.com/mojaloop/helm/muz/update-kafka-topic-overview-dashboard/monitoring/dashboards/messaging/dashboard-kafka-topic-overview.json"
---
apiVersion: grafana.integreatly.org/v1beta1
kind: GrafanaDashboard
metadata:
...
spec:
  ...
  instanceSelector:
    matchLabels:
      dashboards: "grafana"
  url: "https://raw.githubusercontent.com/mojaloop/helm/muz/update-kafka-topic-overview-dashboard/monitoring/dashboards/messaging/dashboard-kafka-cluster-overview.json"
---