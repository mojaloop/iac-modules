...
spec:
  ...
  instanceSelector:
    matchLabels:
      dashboards: "grafana"
  url: "https://raw.githubusercontent.com/mojaloop/helm/v16.0.0-snapshot.6/monitoring/dashboards/messaging/dashboard-kafka-topic-overview.json"
---
apiVersion: grafana.integreatly.org/v1beta1
kind: GrafanaDashboard
metadata:
...
spec:
  ...
  instanceSelector:
    matchLabels:
      dashboards: "grafana"
  url: "https://raw.githubusercontent.com/mojaloop/helm/v16.0.0-snapshot.6/monitoring/dashboards/messaging/dashboard-kafka-cluster-overview.json"
---