...
spec:
  ...
  output:
    name: kratos-oidc-providers
    stringData:
      value: '[{"id":"idp","provider":"generic","client_id":"${kratos_oidc_client_id}","client_secret":"{{ .kratospaswordsecret.${kratos_oidc_client_secret_secret_key} }}","scope":["openid"],"mapper_url":"base64://bG9jYWwgY2xhaW1zID0gc3RkLmV4dFZhcignY2xhaW1zJyk7Cgp7CiAgaWRlbnRpdHk6IHsKICAgIHRyYWl0czogewogICAgICBlbWFpbDogY2xhaW1zLmVtYWlsLAogICAgICBuYW1lOiBjbGFpbXMuZW1haWwsCiAgICAgIHN1YmplY3Q6IGNsYWltcy5zdWIKICAgIH0sCiAgfSwKfQ==","issuer_url":"${keycloak_fqdn}/oauth2/token"}]'
    type: Opaque