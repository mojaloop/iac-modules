...
reporting-hub-bop-shell:
  ...
  config:
    env:
      ...
      LOGOUT_URL: /kratos/self-service/logout/browser?return_url=http%3A%2F%2F${keycloak_fqdn}%2Frealms%2F${keycloak_realm_name}%2Fprotocol%2Fopenid-connect%2Flogout
