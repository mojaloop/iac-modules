...
connection-manager:
  ...
  api:
    ...
    vault:
      ...
      endpoint: http://vault.${vault_namespace}.svc.cluster.local:8200
      mounts:
        pki: ${mcm_pki_path}
        kv: ${mcm_secret_path}
