module "generate_mcm_files" {
  ...
  var_map = {
    ...
    ttk_mcm_rbac_testcases_tag           = try(var.app_var_map.ttk_mcm_rbac_testcases_tag, "20.3.0-mcm-rbac.9")
    mcm_api_image_tag                    = try(var.app_var_map.mcm_api_image_tag, "v3.8.0-snapshot.23")
