module "generate_mojaloop_files" {
  ...
  var_map = {
    ...
    account_lookup_service_affinity                             = yamldecode(yamlencode(var.app_var_map.workload_definitions.account_lookup_service.affinity_definition))
    account_lookup_admin_service_affinity                       = try(yamldecode(var.app_var_map.workload_definitions.account_lookup_service.affinity_definition), null)
    quoting_service_affinity                                    = try(yamldecode(var.app_var_map.workload_definitions.quoting_service.affinity_definition), null)
    ml_api_adapter_service_affinity                             = try(yamldecode(var.app_var_map.workload_definitions.core_api_adapters.affinity_definition), null)
    ml_api_adapter_handler_notifications_affinity               = try(yamldecode(var.app_var_map.workload_definitions.core_api_adapters.affinity_definition), null)
    centralledger_service_affinity                              = try(yamldecode(var.app_var_map.workload_definitions.central_ledger_service.affinity_definition), null)
    central_ledger_handler_transfer_prepare_affinity            = try(yamldecode(var.app_var_map.workload_definitions.central_ledger_service.affinity_definition), null)
    central_ledger_handler_transfer_position_affinity           = try(yamldecode(var.app_var_map.workload_definitions.central_ledger_service.affinity_definition), null)
    central_ledger_handler_transfer_get_affinity                = try(yamldecode(var.app_var_map.workload_definitions.central_ledger_service.affinity_definition), null)
    central_ledger_handler_transfer_fulfil_affinity             = try(yamldecode(var.app_var_map.workload_definitions.central_ledger_service.affinity_definition), null)
    central_ledger_handler_admin_transfer_affinity              = try(yamldecode(var.app_var_map.workload_definitions.central_ledger_service.affinity_definition), null)
    central_settlement_service_affinity                         = try(yamldecode(var.app_var_map.workload_definitions.central_settlement.affinity_definition), null)
    central_settlement_handler_deferredsettlement_affinity      = try(yamldecode(var.app_var_map.workload_definitions.central_settlement.affinity_definition), null)
    central_settlement_handler_grosssettlement_affinity         = try(yamldecode(var.app_var_map.workload_definitions.central_settlement.affinity_definition), null)
    central_settlement_handler_rules_affinity                   = try(yamldecode(var.app_var_map.workload_definitions.central_settlement.affinity_definition), null)
    trasaction_requests_service_affinity                        = try(yamldecode(var.app_var_map.workload_definitions.core_api_adapters.affinity_definition), null)
  }
