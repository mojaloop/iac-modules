module "generate_mojaloop_files" {
  ...
  var_map = {
    ...
    kafka_host                                                        = "${try(module.mojaloop_stateful_resources.stateful_resources[local.mojaloop_kafka_resource_index].logical_service_config.logical_service_name,null)}.${var.stateful_resources_namespace}.svc.cluster.local"
    kafka_port                                                        = try(module.mojaloop_stateful_resources.stateful_resources[local.mojaloop_kafka_resource_index].logical_service_config.logical_service_port,null)
    account_lookup_db_existing_secret                                 = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_als_resource_index].logical_service_config.user_password_secret,null)
    account_lookup_db_user                                            = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_als_resource_index].logical_service_config.username,null)
    account_lookup_db_host                                            = "${try(module.mojaloop_stateful_resources.stateful_resources[local.ml_als_resource_index].logical_service_config.logical_service_name,null)}.${var.stateful_resources_namespace}.svc.cluster.local"
    account_lookup_db_port                                            = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_als_resource_index].logical_service_config.logical_service_port,null)
    account_lookup_db_database                                        = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_als_resource_index].logical_service_config.database_name,null)
    central_ledger_db_existing_secret                                 = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.user_password_secret,null)
    central_ledger_db_user                                            = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.username,null)
    central_ledger_db_host                                            = "${try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.logical_service_name,null)}.${var.stateful_resources_namespace}.svc.cluster.local"
    central_ledger_db_port                                            = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.logical_service_port,null)
    central_ledger_db_database                                        = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.database_name,null)
    central_settlement_db_existing_secret                             = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.user_password_secret,null)
    central_settlement_db_user                                        = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.username,null)
    central_settlement_db_host                                        = "${try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.logical_service_name,null)}.${var.stateful_resources_namespace}.svc.cluster.local"
    central_settlement_db_port                                        = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.logical_service_port,null)
    central_settlement_db_database                                    = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.database_name,null)
    quoting_db_existing_secret                                        = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.user_password_secret,null)
    quoting_db_user                                                   = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.username,null)
    quoting_db_host                                                   = "${try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.logical_service_name,null)}.${var.stateful_resources_namespace}.svc.cluster.local"
    quoting_db_port                                                   = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.logical_service_port,null)
    quoting_db_database                                               = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.database_name,null)
    cep_mongodb_database                                              = try(module.mojaloop_stateful_resources.stateful_resources[local.cep_mongodb_resource_index].logical_service_config.database_name,null)
    cep_mongodb_user                                                  = try(module.mojaloop_stateful_resources.stateful_resources[local.cep_mongodb_resource_index].logical_service_config.username,null)
    cep_mongodb_host                                                  = "${try(module.mojaloop_stateful_resources.stateful_resources[local.cep_mongodb_resource_index].logical_service_config.logical_service_name,null)}.${var.stateful_resources_namespace}.svc.cluster.local"
    cep_mongodb_existing_secret                                       = try(module.mojaloop_stateful_resources.stateful_resources[local.cep_mongodb_resource_index].logical_service_config.user_password_secret,null)
    cep_mongodb_port                                                  = try(module.mojaloop_stateful_resources.stateful_resources[local.cep_mongodb_resource_index].logical_service_config.logical_service_port,null)
    cl_mongodb_database                                               = try(module.mojaloop_stateful_resources.stateful_resources[local.bulk_mongodb_resource_index].logical_service_config.database_name,null)
    cl_mongodb_user                                                   = try(module.mojaloop_stateful_resources.stateful_resources[local.bulk_mongodb_resource_index].logical_service_config.username,null)
    cl_mongodb_host                                                   = "${try(module.mojaloop_stateful_resources.stateful_resources[local.bulk_mongodb_resource_index].logical_service_config.logical_service_name,null)}.${var.stateful_resources_namespace}.svc.cluster.local"
    cl_mongodb_existing_secret                                        = try(module.mojaloop_stateful_resources.stateful_resources[local.bulk_mongodb_resource_index].logical_service_config.user_password_secret,null)
    cl_mongodb_port                                                   = try(module.mojaloop_stateful_resources.stateful_resources[local.bulk_mongodb_resource_index].logical_service_config.logical_service_port,null)
    ttk_mongodb_database                                              = try(module.mojaloop_stateful_resources.stateful_resources[local.ttk_mongodb_resource_index].logical_service_config.database_name,null)
    ttk_mongodb_user                                                  = try(module.mojaloop_stateful_resources.stateful_resources[local.ttk_mongodb_resource_index].logical_service_config.username,null)
    ttk_mongodb_host                                                  = "${try(module.mojaloop_stateful_resources.stateful_resources[local.ttk_mongodb_resource_index].logical_service_config.logical_service_name,null)}.${var.stateful_resources_namespace}.svc.cluster.local"
    ttk_mongodb_existing_secret                                       = try(module.mojaloop_stateful_resources.stateful_resources[local.ttk_mongodb_resource_index].logical_service_config.user_password_secret,null)
    ttk_mongodb_port                                                  = try(module.mojaloop_stateful_resources.stateful_resources[local.ttk_mongodb_resource_index].logical_service_config.logical_service_port,null)
    third_party_consent_db_existing_secret                            = try(module.mojaloop_stateful_resources.stateful_resources[local.third_party_consent_oracle_db_resource_index].logical_service_config.user_password_secret,null)
    third_party_consent_db_user                                       = try(module.mojaloop_stateful_resources.stateful_resources[local.third_party_consent_oracle_db_resource_index].logical_service_config.username,null)
    third_party_consent_db_host                                       = "${try(module.mojaloop_stateful_resources.stateful_resources[local.third_party_consent_oracle_db_resource_index].logical_service_config.logical_service_name,null)}.${var.stateful_resources_namespace}.svc.cluster.local"
    third_party_consent_db_port                                       = try(module.mojaloop_stateful_resources.stateful_resources[local.third_party_consent_oracle_db_resource_index].logical_service_config.logical_service_port,null)
    third_party_consent_db_database                                   = try(module.mojaloop_stateful_resources.stateful_resources[local.third_party_consent_oracle_db_resource_index].logical_service_config.database_name,null)
    third_party_auth_db_existing_secret                               = try(module.mojaloop_stateful_resources.stateful_resources[local.third_party_auth_db_resource_index].logical_service_config.user_password_secret,null)
    third_party_auth_db_user                                          = try(module.mojaloop_stateful_resources.stateful_resources[local.third_party_auth_db_resource_index].logical_service_config.username,null)
    third_party_auth_db_host                                          = "${try(module.mojaloop_stateful_resources.stateful_resources[local.third_party_auth_db_resource_index].logical_service_config.logical_service_name,null)}.${var.stateful_resources_namespace}.svc.cluster.local"
    third_party_auth_db_port                                          = try(module.mojaloop_stateful_resources.stateful_resources[local.third_party_auth_db_resource_index].logical_service_config.logical_service_port,null)
    third_party_auth_db_database                                      = try(module.mojaloop_stateful_resources.stateful_resources[local.third_party_auth_db_resource_index].logical_service_config.database_name,null)
    third_party_auth_redis_host                                       = "${try(module.mojaloop_stateful_resources.stateful_resources[local.third_party_redis_resource_index].logical_service_config.logical_service_name,null)}.${var.stateful_resources_namespace}.svc.cluster.local"
    third_party_auth_redis_port                                       = try(module.mojaloop_stateful_resources.stateful_resources[local.third_party_redis_resource_index].logical_service_config.logical_service_port,null)
    ttksims_redis_host                                                = "${try(module.mojaloop_stateful_resources.stateful_resources[local.ttk_redis_resource_index].logical_service_config.logical_service_name,null)}.${var.stateful_resources_namespace}.svc.cluster.local"
    ttksims_redis_port                                                = try(module.mojaloop_stateful_resources.stateful_resources[local.ttk_redis_resource_index].logical_service_config.logical_service_port,null)
    ...
    reporting_db_secret_name                                          = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.user_password_secret,null)
    reporting_db_user                                                 = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.username,null)
    reporting_db_host                                                 = "${try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.logical_service_name,null)}.${var.stateful_resources_namespace}.svc.cluster.local"
    reporting_db_port                                                 = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.logical_service_port,null)
    reporting_db_database                                             = try(module.mojaloop_stateful_resources.stateful_resources[local.ml_cl_resource_index].logical_service_config.database_name,null)
    reporting_db_secret_key                                           = "mysql-password"
    reporting_events_mongodb_database                                 = try(module.mojaloop_stateful_resources.stateful_resources[local.reporting_events_mongodb_resource_index].logical_service_config.database_name,null)
    reporting_events_mongodb_user                                     = try(module.mojaloop_stateful_resources.stateful_resources[local.reporting_events_mongodb_resource_index].logical_service_config.username,null)
    reporting_events_mongodb_host                                     = "${try(module.mojaloop_stateful_resources.stateful_resources[local.reporting_events_mongodb_resource_index].logical_service_config.logical_service_name,null)}.${var.stateful_resources_namespace}.svc.cluster.local"
    reporting_events_mongodb_existing_secret                          = try(module.mojaloop_stateful_resources.stateful_resources[local.reporting_events_mongodb_resource_index].logical_service_config.user_password_secret,null)
    reporting_events_mongodb_port                                     = try(module.mojaloop_stateful_resources.stateful_resources[local.reporting_events_mongodb_resource_index].logical_service_config.logical_service_port,null)
