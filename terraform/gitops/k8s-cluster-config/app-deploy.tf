module "mojaloop" {
  ...
  mojaloop_stateful_resources_config_file = var.mojaloop_stateful_resources_config_file
...
module "vnext" {
  ...
  mcm_ingress_internal_lb              = var.app_var_map.mcm_ingress_internal_lb
  vnext_stateful_resources_config_file = var.vnext_stateful_resources_config_file
  local_vault_kv_root_path             = local.local_vault_kv_root_path
  app_var_map                          = var.app_var_map
  auth_fqdn                            = local.auth_fqdn
  ory_namespace                        = var.ory_namespace
