...
locals {
  ...
  pm4ml_chart_repo                    = startswith(var.app_var_map.pm4ml_chart_repo, "oci://") && can(regex("(oci://[^/]+)(.*)", var.app_var_map.pm4ml_chart_repo)) ? try("${local.helm_proxy_repos_map[regex("(oci://[^/]+)(.*)", var.app_var_map.pm4ml_chart_repo)[0]]}${regex("(oci://[^/]+)(.*)", var.app_var_map.pm4ml_chart_repo)[1]}", var.app_var_map.pm4ml_chart_repo) : try(local.helm_proxy_repos_map[var.app_var_map.pm4ml_chart_repo], var.app_var_map.pm4ml_chart_repo)
  mojaloop_charts_repo                = startswith(var.app_var_map.mojaloop_charts_repo, "oci://") && can(regex("(oci://[^/]+)(.*)", var.app_var_map.mojaloop_charts_repo)) ? try("${local.helm_proxy_repos_map[regex("(oci://[^/]+)(.*)", var.app_var_map.mojaloop_charts_repo)[0]]}${regex("(oci://[^/]+)(.*)", var.app_var_map.mojaloop_charts_repo)[1]}", var.app_var_map.mojaloop_charts_repo) : try(local.helm_proxy_repos_map[var.app_var_map.mojaloop_charts_repo], var.app_var_map.mojaloop_charts_repo)
  mcm_chart_repo                      = startswith(var.app_var_map.mcm_chart_repo, "oci://") && can(regex("(oci://[^/]+)(.*)", var.app_var_map.mcm_chart_repo)) ? try("${local.helm_proxy_repos_map[regex("(oci://[^/]+)(.*)", var.app_var_map.mcm_chart_repo)[0]]}${regex("(oci://[^/]+)(.*)", var.app_var_map.mcm_chart_repo)[1]}", var.app_var_map.mcm_chart_repo) : try(local.helm_proxy_repos_map[var.app_var_map.mcm_chart_repo], var.app_var_map.mcm_chart_repo)
  mojaloop_helm_repo                  = startswith(var.app_var_map.mojaloop_helm_repo, "oci://") && can(regex("(oci://[^/]+)(.*)", var.app_var_map.mojaloop_helm_repo)) ? try("${local.helm_proxy_repos_map[regex("(oci://[^/]+)(.*)", var.app_var_map.mojaloop_helm_repo)[0]]}${regex("(oci://[^/]+)(.*)", var.app_var_map.mojaloop_helm_repo)[1]}", var.app_var_map.mojaloop_helm_repo) : try(local.helm_proxy_repos_map[var.app_var_map.mojaloop_helm_repo], var.app_var_map.mojaloop_helm_repo)
  mojaloop_reporting_templates_repo   = startswith(var.app_var_map.mojaloop_reporting_templates_repo, "oci://") && can(regex("(oci://[^/]+)(.*)", var.app_var_map.mojaloop_reporting_templates_repo)) ? try("${local.helm_proxy_repos_map[regex("(oci://[^/]+)(.*)", var.app_var_map.mojaloop_reporting_templates_repo)[0]]}${regex("(oci://[^/]+)(.*)", var.app_var_map.mojaloop_reporting_templates_repo)[1]}", var.app_var_map.mojaloop_reporting_templates_repo) : try(local.helm_proxy_repos_map[var.app_var_map.mojaloop_reporting_templates_repo], var.app_var_map.mojaloop_reporting_templates_repo)
}
