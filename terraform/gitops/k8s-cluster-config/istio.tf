...
locals {
  ...
  istio_chart_repo = try(local.helm_proxy_repos_map[var.istio_chart_repo], var.istio_chart_repo)
  kiali_chart_repo = try(local.helm_proxy_repos_map[var.kiali_chart_repo], var.kiali_chart_repo)
}
