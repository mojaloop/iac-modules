module "generate_ory_files" {
  ...
  var_map = {
    ...
    keto_postgres_secret_path            = "${module.common_stateful_resources.stateful_resources[local.keto_postgres_resource_index].local_resource_config.generate_secret_vault_base_path}/${module.common_stateful_resources.stateful_resources[local.keto_postgres_resource_index].resource_name}/${module.common_stateful_resources.stateful_resources[local.keto_postgres_resource_index].local_resource_config.generate_secret_name}-password"
...
locals {
  ...
  kratos_postgres_resource_index = index(module.common_stateful_resources.stateful_resources.*.resource_name, "kratos-db")
  keto_postgres_resource_index   = index(module.common_stateful_resources.stateful_resources.*.resource_name, "keto-db")
