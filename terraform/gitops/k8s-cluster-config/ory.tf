module "generate_ory_files" {
  ...
  var_map = {
    ...
    keto_postgres_secret_path            = "${try(module.common_stateful_resources.stateful_resources[local.keto_postgres_resource_index].local_helm_config.generate_secret_vault_base_path,"")}/${local.keto_postgres_resource_index}/${try(module.common_stateful_resources.stateful_resources[local.keto_postgres_resource_index].local_helm_config.generate_secret_name,"")}-password"
    ...
    kratos_postgres_secret_path          = "${try(module.common_stateful_resources.stateful_resources[local.kratos_postgres_resource_index].local_helm_config.generate_secret_vault_base_path,"")}/${local.kratos_postgres_resource_index}/${try(module.common_stateful_resources.stateful_resources[local.kratos_postgres_resource_index].local_helm_config.generate_secret_name,"")}-password"
