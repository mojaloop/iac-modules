module "generate_ory_files" {
  ...
  var_map = {
    ...
    keto_mysql_password_secret_key    = try(module.common_stateful_resources.stateful_resources[local.keto_mysql_resource_index].logical_service_config.user_password_secret_key,"")
