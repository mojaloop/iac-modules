...
locals {
  ...
  loki_canary_repo = startswith(try(var.common_var_map.loki_canary_repo, var.loki_canary_repo), "oci://") && can(regex("oci://([^/]+)(.*)", try(var.common_var_map.loki_canary_repo, var.loki_canary_repo))) ? try("${local.helm_proxy_repos_map[regex("oci://([^/]+)(.*)", try(var.common_var_map.loki_canary_repo, var.loki_canary_repo))[0]]}${regex("oci://([^/]+)(.*)", try(var.common_var_map.loki_canary_repo, var.loki_canary_repo))[1]}", try(var.common_var_map.loki_canary_repo, var.loki_canary_repo)) : try(local.helm_proxy_repos_map[try(var.common_var_map.loki_canary_repo, var.loki_canary_repo)], try(var.common_var_map.loki_canary_repo, var.loki_canary_repo))
  prometheus_crd_repo = startswith(try(var.common_var_map.prometheus_crd_repo, var.prometheus_crd_repo), "oci://") && can(regex("oci://([^/]+)(.*)", try(var.common_var_map.prometheus_crd_repo, var.prometheus_crd_repo))) ? try("${local.helm_proxy_repos_map[regex("oci://([^/]+)(.*)", try(var.common_var_map.prometheus_crd_repo, var.prometheus_crd_repo))[0]]}${regex("oci://([^/]+)(.*)", try(var.common_var_map.prometheus_crd_repo, var.prometheus_crd_repo))[1]}", try(var.common_var_map.prometheus_crd_repo, var.prometheus_crd_repo)) : try(local.helm_proxy_repos_map[try(var.common_var_map.prometheus_crd_repo, var.prometheus_crd_repo)], try(var.common_var_map.prometheus_crd_repo, var.prometheus_crd_repo))
  opentelemetry_repo = startswith(try(var.common_var_map.opentelemetry_chart_repo, var.opentelemetry_chart_repo), "oci://") && can(regex("oci://([^/]+)(.*)", try(var.common_var_map.opentelemetry_chart_repo, var.opentelemetry_chart_repo))) ? try("${local.helm_proxy_repos_map[regex("oci://([^/]+)(.*)", try(var.common_var_map.opentelemetry_chart_repo, var.opentelemetry_chart_repo))[0]]}${regex("oci://([^/]+)(.*)", try(var.common_var_map.opentelemetry_chart_repo, var.opentelemetry_chart_repo))[1]}", try(var.common_var_map.opentelemetry_chart_repo, var.opentelemetry_chart_repo)) : try(local.helm_proxy_repos_map[try(var.common_var_map.opentelemetry_chart_repo, var.opentelemetry_chart_repo)], try(var.common_var_map.opentelemetry_chart_repo, var.opentelemetry_chart_repo))
  alloy_repo = startswith(try(var.common_var_map.alloy_chart_repo, var.alloy_chart_repo), "oci://") && can(regex("oci://([^/]+)(.*)", try(var.common_var_map.alloy_chart_repo, var.alloy_chart_repo))) ? try("${local.helm_proxy_repos_map[regex("oci://([^/]+)(.*)", try(var.common_var_map.alloy_chart_repo, var.alloy_chart_repo))[0]]}${regex("oci://([^/]+)(.*)", try(var.common_var_map.alloy_chart_repo, var.alloy_chart_repo))[1]}", try(var.common_var_map.alloy_chart_repo, var.alloy_chart_repo)) : try(local.helm_proxy_repos_map[try(var.common_var_map.alloy_chart_repo, var.alloy_chart_repo)], try(var.common_var_map.alloy_chart_repo, var.alloy_chart_repo))
  metrics_server_chart_repo = startswith(try(var.common_var_map.metrics_server_chart_repo, var.metrics_server_chart_repo), "oci://") && can(regex("oci://([^/]+)(.*)", try(var.common_var_map.metrics_server_chart_repo, var.metrics_server_chart_repo))) ? try("${local.helm_proxy_repos_map[regex("oci://([^/]+)(.*)", try(var.common_var_map.metrics_server_chart_repo, var.metrics_server_chart_repo))[0]]}${regex("oci://([^/]+)(.*)", try(var.common_var_map.metrics_server_chart_repo, var.metrics_server_chart_repo))[1]}", try(var.common_var_map.metrics_server_chart_repo, var.metrics_server_chart_repo)) : try(local.helm_proxy_repos_map[try(var.common_var_map.metrics_server_chart_repo, var.metrics_server_chart_repo)], try(var.common_var_map.metrics_server_chart_repo, var.metrics_server_chart_repo))
  grafana_chart_repo = startswith(try(var.common_var_map.grafana_chart_repo, var.grafana_chart_repo), "oci://") && can(regex("oci://([^/]+)(.*)", try(var.common_var_map.grafana_chart_repo, var.grafana_chart_repo))) ? try("${local.helm_proxy_repos_map[regex("oci://([^/]+)(.*)", try(var.common_var_map.grafana_chart_repo, var.grafana_chart_repo))[0]]}${regex("oci://([^/]+)(.*)", try(var.common_var_map.grafana_chart_repo, var.grafana_chart_repo))[1]}", try(var.common_var_map.grafana_chart_repo, var.grafana_chart_repo)) : try(local.helm_proxy_repos_map[try(var.common_var_map.grafana_chart_repo, var.grafana_chart_repo)], try(var.common_var_map.grafana_chart_repo, var.grafana_chart_repo))
  prometheus_operator_repo = startswith(try(var.common_var_map.prometheus_operator_repo, var.prometheus_operator_repo), "oci://") && can(regex("oci://([^/]+)(.*)", try(var.common_var_map.prometheus_operator_repo, var.prometheus_operator_repo))) ? try("${local.helm_proxy_repos_map[regex("oci://([^/]+)(.*)", try(var.common_var_map.prometheus_operator_repo, var.prometheus_operator_repo))[0]]}${regex("oci://([^/]+)(.*)", try(var.common_var_map.prometheus_operator_repo, var.prometheus_operator_repo))[1]}", try(var.common_var_map.prometheus_operator_repo, var.prometheus_operator_repo)) : try(local.helm_proxy_repos_map[try(var.common_var_map.prometheus_operator_repo, var.prometheus_operator_repo)], try(var.common_var_map.prometheus_operator_repo, var.prometheus_operator_repo))
  loki_repo = startswith(try(var.common_var_map.loki_repo, var.loki_repo), "oci://") && can(regex("oci://([^/]+)(.*)", try(var.common_var_map.loki_repo, var.loki_repo))) ? try("${local.helm_proxy_repos_map[regex("oci://([^/]+)(.*)", try(var.common_var_map.loki_repo, var.loki_repo))[0]]}${regex("oci://([^/]+)(.*)", try(var.common_var_map.loki_repo, var.loki_repo))[1]}", try(var.common_var_map.loki_repo, var.loki_repo)) : try(local.helm_proxy_repos_map[try(var.common_var_map.loki_repo, var.loki_repo)], try(var.common_var_map.loki_repo, var.loki_repo))
  grafana_operator_repo = startswith(try(var.common_var_map.grafana_operator_repo, var.grafana_operator_repo), "oci://") && can(regex("oci://([^/]+)(.*)", try(var.common_var_map.grafana_operator_repo, var.grafana_operator_repo))) ? try("${local.helm_proxy_repos_map[regex("oci://([^/]+)(.*)", try(var.common_var_map.grafana_operator_repo, var.grafana_operator_repo))[0]]}${regex("oci://([^/]+)(.*)", try(var.common_var_map.grafana_operator_repo, var.grafana_operator_repo))[1]}", try(var.common_var_map.grafana_operator_repo, var.grafana_operator_repo)) : try(local.helm_proxy_repos_map[try(var.common_var_map.grafana_operator_repo, var.grafana_operator_repo)], try(var.common_var_map.grafana_operator_repo, var.grafana_operator_repo))
}
