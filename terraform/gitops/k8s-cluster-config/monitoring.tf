module "generate_monitoring_files" {
  ...
  var_map = {
    ...
    client_id                            = data.vault_generic_secret.grafana_oauth_client_id[0].data.value
    client_secret                        = data.vault_generic_secret.grafana_oauth_client_secret[0].data.value
