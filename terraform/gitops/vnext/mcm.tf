module "generate_mcm_files" {
  ...
  var_map = {
    ...
    db_user                              = module.vnext_stateful_resources.stateful_resources[local.mcm_resource_index].logical_service_config.username
...
locals {
  ...
  mcm_resource_index             = index(module.vnext_stateful_resources.stateful_resources.*.resource_name, "mcm-db")
