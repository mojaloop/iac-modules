module "generate_vnext_files" {
  ...
  var_map = {
    ...
    vnext_mongo_secret_path              = "${module.vnext_stateful_resources.stateful_resources[local.vnext_mongodb_resource_index].local_helm_config.generate_secret_vault_base_path}/${local.vnext_mongodb_resource_index}/${module.vnext_stateful_resources.stateful_resources[local.vnext_mongodb_resource_index].local_helm_config.secret_config.generate_secret_name}-mongodb-root-password"
