module "generate_vnext_files" {
  ...
  var_map = {
    ...
    vnext_redis_host                         = "${local.stateful_resources[local.vnext_redis_resource_index].logical_service_config.logical_service_name}.${var.stateful_resources_namespace}.svc.cluster.local"
    vnext_redis_port                         = local.stateful_resources[local.vnext_redis_resource_index].logical_service_config.logical_service_port
