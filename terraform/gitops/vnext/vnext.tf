module "generate_vnext_files" {
  ...
  var_map = {
    ...
    vnext_mongo_secret_path              = "${local.stateful_resources[local.vnext_mongodb_resource_index].local_resource_config.generate_secret_vault_base_path}/${local.stateful_resources[local.vnext_mongodb_resource_index].resource_name}/${local.stateful_resources[local.vnext_mongodb_resource_index].local_resource_config.generate_secret_name}-mongodb-passwords"
