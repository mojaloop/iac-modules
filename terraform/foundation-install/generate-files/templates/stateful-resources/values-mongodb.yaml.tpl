...
##
global:
  storageClass: ${resource.local_resource.mongodb_data.storage_class_name}
...
auth:
  ...
  database: ${resource.local_resource.mongodb_data.database_name}
  username: ${resource.local_resource.mongodb_data.user}
...
persistence:
  ...
  ##
  enabled: true
  size: ${resource.local_resource.mongodb_data.storage_size}
service:
  ports:
