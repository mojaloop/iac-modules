    ...
    utils:
      ...
      sub_apps:
        ...
        istio:
          ...
          cni_platform: "${istio_cni_platform}"
        cert_manager:
        ...
        capi:
          ...
          capi_rook_ceph_osd_memory_limit: "${rook_ceph_osd_memory_limit}"
          capi_rook_ceph_osd_cpu_request: "${rook_ceph_osd_cpu_request}"
          capi_rook_ceph_osd_memory_request: "${rook_ceph_osd_memory_request}"
          capi_rook_ceph_osd_memory_target: "${rook_ceph_osd_memory_target}"
          capi_rook_ceph_osd_memory_target_autotune: "${rook_ceph_osd_memory_target_autotune}"
          capi_rook_ceph_osd_mclock_override_recovery_settings: "${rook_ceph_osd_mclock_override_recovery_settings}"
          capi_rook_ceph_osd_recovery_max_active_hdd: "${rook_ceph_osd_recovery_max_active_hdd}"
          capi_rook_ceph_osd_recovery_max_active_ssd: "${rook_ceph_osd_recovery_max_active_ssd}"
    ...
    security:
      ...
      sub_apps:
        ...
        zitadel_percona_provider:
          ...
          backup_endpoint: "${zitadel_perc_backup_endpoint != "" ? zitadel_perc_backup_endpoint : "s3.${zitadel_perc_backup_region != "" ? zitadel_perc_backup_region : (backup_region != "" ? backup_region : cloud_region)}.amazonaws.com"}"
          backup_bucket: "${zitadel_perc_backup_bucket}"
          backup_region: "${zitadel_perc_backup_region != "" ? zitadel_perc_backup_region : (backup_region != "" ? backup_region : cloud_region)}"
        ...
        netbird_percona_provider:
          ...
          backup_endpoint: "${netbird_perc_backup_endpoint != "" ? netbird_perc_backup_endpoint : "s3.${netbird_perc_backup_region != "" ? netbird_perc_backup_region : (backup_region != "" ? backup_region : cloud_region)}.amazonaws.com"}"
          backup_bucket: "${netbird_perc_backup_bucket}"
          backup_region: "${netbird_perc_backup_region != "" ? netbird_perc_backup_region : (backup_region != "" ? backup_region : cloud_region)}"
    ...
    gitlab:
      ...
      sub_apps:
        ...
        webdb_percona_provider:
          ...
          backup_endpoint: "${gitlab_perc_backup_endpoint != "" ? gitlab_perc_backup_endpoint : "s3.${gitlab_perc_backup_region != "" ? gitlab_perc_backup_region : (backup_region != "" ? backup_region : cloud_region)}.amazonaws.com"}"
          backup_bucket: "${gitlab_perc_backup_bucket}"
          backup_region: "${gitlab_perc_backup_region != "" ? gitlab_perc_backup_region : (backup_region != "" ? backup_region : cloud_region)}"
        ...
        praefectdb_percona_provider:
          ...
          backup_endpoint: "${praefect_perc_backup_endpoint != "" ? praefect_perc_backup_endpoint : "s3.${praefect_perc_backup_region != "" ? praefect_perc_backup_region : (backup_region != "" ? backup_region : cloud_region)}.amazonaws.com"}"
          backup_bucket: "${praefect_perc_backup_bucket}"
          backup_region: "${praefect_perc_backup_region != "" ? praefect_perc_backup_region : (backup_region != "" ? backup_region : cloud_region)}"
    ...
    deploy_env:
      ...
      sub_apps:
        ...
        onboard:
          ...
          vault_backup_bucket_storage_size: "${vault_backup_bucket_storage_size}"
    ...
    monitoring:
      ...
      sub_apps:
        ...
        tempo:
          ...
          distributor_limits_memory: "${tempo_distributor_limits_memory}"
          querier_limits_cpu: "${tempo_querier_limits_cpu}"
          querier_limits_memory: "${tempo_querier_limits_memory}"
          compactor_limits_cpu: "${tempo_compactor_limits_cpu}"
          compactor_limits_memory: "${tempo_compactor_limits_memory}"
          ingester_limits_cpu: "${tempo_ingester_limits_cpu}"
          ingester_limits_memory: "${tempo_ingester_limits_memory}"
          query_frontend_limits_cpu: "${tempo_query_frontend_limits_cpu}"
          ...
          distributor_requests_cpu: "${tempo_distributor_requests_cpu}"
          distributor_requests_memory: "${tempo_distributor_requests_memory}"
          querier_requests_cpu: "${tempo_querier_requests_cpu}"
          querier_requests_memory: "${tempo_querier_requests_memory}"
          compactor_requests_cpu: "${tempo_compactor_requests_cpu}"
          compactor_requests_memory: "${tempo_compactor_requests_memory}"
          ingester_requests_cpu: "${tempo_ingester_requests_cpu}"
          ingester_requests_memory: "${tempo_ingester_requests_memory}"
          query_frontend_requests_cpu: "${tempo_query_frontend_requests_cpu}"
          query_frontend_requests_memory: "${tempo_query_frontend_requests_memory}"
          metrics_generator_requests_cpu: "${tempo_metrics_generator_requests_cpu}"
          metrics_generator_requests_memory: "${tempo_metrics_generator_requests_memory}"
