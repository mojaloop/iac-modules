    ...
    gitlab:
      ...
      sub_apps:
        ...
        pre:
          ...
          percona_postgres_storage_size: "${format("%sGi",gitlab_postgres_storage_size)}"
          ...
          percona_praefect_postgres_storage_size: "${format("%sGi",gitlab_praefect_postgres_storage_size)}"
