    ...
    utils:
      ...
      sub_apps:
        argocd_helm:
          ...
          server_requests_cpu: "${argocd_server_requests_cpu}"
          server_requests_memory: "${argocd_server_requests_memory}"
          server_limits_cpu: "${argocd_server_limits_cpu}"
          server_limits_memory: "${argocd_server_limits_memory}"
          repo_server_requests_cpu: "${argocd_repo_server_requests_cpu}"
          repo_server_requests_memory: "${argocd_repo_server_requests_memory}"
          repo_server_limits_cpu: "${argocd_repo_server_limits_cpu}"
          repo_server_limits_memory: "${argocd_repo_server_limits_memory}"
          application_controller_requests_cpu: "${argocd_application_controller_requests_cpu}"
          application_controller_requests_memory: "${argocd_application_controller_requests_memory}"
          application_controller_limits_cpu: "${argocd_application_controller_limits_cpu}"
          application_controller_limits_memory: "${argocd_application_controller_limits_memory}"
          applicationset_controller_requests_cpu: "${argocd_applicationset_controller_requests_cpu}"
          applicationset_controller_requests_memory: "${argocd_applicationset_controller_requests_memory}"
          applicationset_controller_limits_cpu: "${argocd_applicationset_controller_limits_cpu}"
          applicationset_controller_limits_memory: "${argocd_applicationset_controller_limits_memory}"
          notifications_controller_requests_cpu: "${argocd_notifications_controller_requests_cpu}"
          notifications_controller_requests_memory: "${argocd_notifications_controller_requests_memory}"
          notifications_controller_limits_cpu: "${argocd_notifications_controller_limits_cpu}"
          notifications_controller_limits_memory: "${argocd_notifications_controller_limits_memory}"
          redis_requests_cpu: "${argocd_redis_requests_cpu}"
          redis_requests_memory: "${argocd_redis_requests_memory}"
          redis_limits_cpu: "${argocd_redis_limits_cpu}"
          redis_limits_memory: "${argocd_redis_limits_memory}"
        rook_ceph:
        ...
        crossplane_providers:
          ...
          requests_cpu: "${crossplane_provider_requests_cpu}"
          requests_memory: "${crossplane_provider_requests_memory}"
          limits_cpu: "${crossplane_provider_limits_cpu}"
          limits_memory: "${crossplane_provider_limits_memory}"
    ...
    gitlab:
      ...
      sub_apps:
        gitlab:
          ...
          dns_hyphenated_subdomain: "${replace(dns_public_subdomain, ".", "-")}"
          webservice_requests_cpu: "${gitlab_webservice_requests_cpu}"
          webservice_requests_memory: "${gitlab_webservice_requests_memory}"
          webservice_limits_cpu: "${gitlab_webservice_limits_cpu}"
          webservice_limits_memory: "${gitlab_webservice_limits_memory}"
          sidekiq_requests_cpu: "${gitlab_sidekiq_requests_cpu}"
          sidekiq_requests_memory: "${gitlab_sidekiq_requests_memory}"
          sidekiq_limits_cpu: "${gitlab_sidekiq_limits_cpu}"
          sidekiq_limits_memory: "${gitlab_sidekiq_limits_memory}"
          gitaly_requests_cpu: "${gitlab_gitaly_requests_cpu}"
          gitaly_requests_memory: "${gitlab_gitaly_requests_memory}"
          gitaly_limits_cpu: "${gitlab_gitaly_limits_cpu}"
          gitaly_limits_memory: "${gitlab_gitaly_limits_memory}"
          shell_requests_cpu: "${gitlab_shell_requests_cpu}"
          shell_requests_memory: "${gitlab_shell_requests_memory}"
          shell_limits_cpu: "${gitlab_shell_limits_cpu}"
          shell_limits_memory: "${gitlab_shell_limits_memory}"
          exporter_requests_cpu: "${gitlab_exporter_requests_cpu}"
          exporter_requests_memory: "${gitlab_exporter_requests_memory}"
          exporter_limits_cpu: "${gitlab_exporter_limits_cpu}"
          exporter_limits_memory: "${gitlab_exporter_limits_memory}"
          toolbox_requests_cpu: "${gitlab_toolbox_requests_cpu}"
          toolbox_requests_memory: "${gitlab_toolbox_requests_memory}"
          toolbox_limits_cpu: "${gitlab_toolbox_limits_cpu}"
          toolbox_limits_memory: "${gitlab_toolbox_limits_memory}"
          praefect_requests_cpu: "${gitlab_praefect_requests_cpu}"
          praefect_requests_memory: "${gitlab_praefect_requests_memory}"
          praefect_limits_cpu: "${gitlab_praefect_limits_cpu}"
          praefect_limits_memory: "${gitlab_praefect_limits_memory}"
          registry_requests_cpu: "${gitlab_registry_requests_cpu}"
          registry_requests_memory: "${gitlab_registry_requests_memory}"
          registry_limits_cpu: "${gitlab_registry_limits_cpu}"
          registry_limits_memory: "${gitlab_registry_limits_memory}"
        pre:
    ...
    monitoring:
      ...
      sub_apps:
        ...
        monitoring:
          ...
          cluster_domain: "${cluster_domain}"
          dns_hyphenated_subdomain: "${replace(dns_public_subdomain, ".", "-")}"
          prometheus_requests_cpu: "${prometheus_requests_cpu}"
          prometheus_requests_memory: "${prometheus_requests_memory}"
          prometheus_limits_cpu: "${prometheus_limits_cpu}"
          prometheus_limits_memory: "${prometheus_limits_memory}"
          prometheus_operator_requests_cpu: "${prometheus_operator_requests_cpu}"
          prometheus_operator_requests_memory: "${prometheus_operator_requests_memory}"
          prometheus_operator_limits_cpu: "${prometheus_operator_limits_cpu}"
          prometheus_operator_limits_memory: "${prometheus_operator_limits_memory}"
        grafana:
