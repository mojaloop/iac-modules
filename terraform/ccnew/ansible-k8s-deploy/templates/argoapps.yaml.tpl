    ...
    utils:
      ...
      sub_apps:
        ...
        capi:
          ...
          capi_rook_ceph_rgw_subdomain: "cephobjectstore.${internal_cluster_domain}"
        ...
        storage:
          cloud_provider: "${cloud_platform}"
          cluster_domain: "${cluster_domain}"
          object_storage_host: "${object_storage_provider == "s3" ? "s3.amazonaws.com" : "cephobjectstore.${internal_cluster_domain}" }"
          object_storage_regional_host: "${object_storage_provider == "s3" ? "s3.${cloud_region}.amazonaws.com" : "cephobjectstore.${internal_cluster_domain}" }"
          object_storage_endpoint: "${object_storage_provider == "s3" ? "https://s3.amazonaws.com" : "http://cephobjectstore.${internal_cluster_domain}" }"
          object_storage_regional_endpoint: "${object_storage_provider == "s3" ? "https://s3.${cloud_region}.amazonaws.com" : "http://cephobjectstore.${internal_cluster_domain}" }"
    ...
    velero:
      ...
      sub_apps:
        ...
        velero:
          ...
          object_storage_endpoint: "${cc_backup_object_storage_provider == "s3" ? "https://s3.amazonaws.com" : "http://cephobjectstore.${internal_cluster_domain}" }"
