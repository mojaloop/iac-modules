    ...
    utils:
      ...
      sub_apps:
        ...
        storage:
          cloud_provider: "${cloud_platform}"
          cluster_domain: "${cluster_domain}"
          object_storage_host: "${object_storage_provider == "s3" ? "s3.amazonaws.com" : "s3.${cluster_domain}" }"
          object_storage_regional_host: "${object_storage_provider == "s3" ? "s3.${cloud_region}.amazonaws.com" : "s3.${cluster_domain}" }"
          object_storage_endpoint: "${object_storage_provider == "s3" ? "https://s3.amazonaws.com" : "http://s3.${cluster_domain}" }"
          object_storage_regional_endpoint: "${object_storage_provider == "s3" ? "https://s3.${cloud_region}.amazonaws.com" : "http://s3.${cluster_domain}" }"
