...
locals {
  ...
  private_zone                  = var.configure_route_53 ? (var.create_private_zone ? aws_route53_zone.public_int[0] : data.aws_route53_zone.private[0]) : null
  public_int_domain             = var.configure_route_53 ? (var.create_public_zone ? aws_route53_zone.public_int[0] : data.aws_route53_zone.public_int[0]) : null
