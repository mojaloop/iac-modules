...
locals {
  ...
  cluster_parent_zone_id        = length(data.aws_route53_zone.cluster_parent) > 0 ? data.aws_route53_zone.cluster_parent[0].zone_id : aws_route53_zone.cluster_parent[0].zone_id
